...
- Building real-world apps: an emergency blood donation platform, AI tools, and more
...
- 🩸 **LifeFlow** — Emergency blood donation platform built with React, TypeScript, Vite & Firebase. Features Google OAuth, real-time donor matching, proximity-based in-app notifications, and an AI-powered eligibility advisor.
- 😂 **Meme Generator** — Next.js app that generates memes using the Imgflip API.
